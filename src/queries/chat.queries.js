export const getAllChatsWithLatestMessagesQuery = `
        ...
        SELECT 
            ...
            fs.status AS "otherUser.friendshipStatus"
        ...
        LEFT JOIN Friendships fs
          ON (lm.senderId = fs.requesterId AND lm.receiverId = fs.addresseeId)
          OR (lm.senderId = fs.addresseeId AND lm.receiverId = fs.requesterId)
